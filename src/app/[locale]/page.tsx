...
export default async function Home() {
  ...
  const menu: MenuSection[] = [
    {
      ...
      items: [
        {
          name: gt("French Onion Soup"),
          description: gt("Slow-cooked onion broth with melted Gruyere and toasted bread"),
          price: 12,
          dietary: "vegetarian",
          spiceLevel: 0,
        },
        {
          name: gt("Tuna Tartare"),
          description: gt("Fresh yellowfin tuna with avocado, sesame, and citrus ponzu"),
          price: 18,
          dietary: "none",
          spiceLevel: 1,
        },
        {
          name: gt("Roasted Beet Salad"),
          description: gt("Heirloom beets with goat cheese, candied walnuts, and arugula"),
          price: 14,
          dietary: "vegetarian",
          spiceLevel: 0,
        },
    ...
    {
      title: gt("Main Courses"),
      items: [
        {
          name: gt("Pan-Seared Salmon"),
          description: gt("Atlantic salmon with lemon-dill sauce, asparagus, and fingerling potatoes"),
          price: 32,
          dietary: "none",
          spiceLevel: 0,
        },
        {
          name: gt("Grilled Ribeye"),
          description: gt("Dry-aged 14oz ribeye with truffle butter, roasted garlic, and seasonal vegetables"),
          price: 48,
          dietary: "none",
          spiceLevel: 0,
        },
        {
          name: gt("Wild Mushroom Risotto"),
          description: gt("Arborio rice with porcini, chanterelle, and shaved Parmigiano-Reggiano"),
          price: 26,
          dietary: "vegetarian",
          spiceLevel: 0,
        },
        {
          name: gt("Thai Red Curry"),
          description: gt("Coconut milk curry with seasonal vegetables, jasmine rice, and Thai basil"),
          price: 24,
          dietary: "vegan",
          spiceLevel: 3,
        },
    ...
    },
    {
      ...
      items: [
        {
          name: gt("Creme Brulee"),
          description: gt("Classic vanilla custard with caramelized sugar and fresh berries"),
          price: 14,
          dietary: "vegetarian",
          spiceLevel: 0,
        },
        {
          name: gt("Dark Chocolate Fondant"),
          description: gt("Warm chocolate cake with a molten center, served with vanilla ice cream"),
          price: 16,
          dietary: "vegetarian",
          spiceLevel: 0,
        },
        {
          name: gt("Mango Sorbet"),
          description: gt("House-made tropical sorbet with lime zest and fresh mint"),
          price: 10,
          dietary: "vegan",
          spiceLevel: 0,
        },
  ...
  return (
    <div className="min-h-screen bg-neutral-950 font-sans text-neutral-200">
      <div className="bg-amber-900/30 border-b border-amber-800/50 text-center py-2 px-4">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 pt-6 border-t border-neutral-800 text-center text-sm text-neutral-500">
          <T>
            ...
            {" "}to demonstrate Currency, Num, Branch, and T components
